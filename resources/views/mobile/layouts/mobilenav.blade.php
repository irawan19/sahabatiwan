<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="{{URL('/mobile')}}" aria-label="logo {{$lihat_konfigurasi_aplikasis->nama_konfigurasi_aplikasis}}">
            <img src="{{URL::asset('storage/'.$lihat_konfigurasi_aplikasis->logo_konfigurasi_aplikasis)}}" width="94" alt="{{$lihat_konfigurasi_aplikasis->nama_konfigurasi_aplikasis}}" /></a>
        </div>
