				...
				<form class="form-horizontal m-t-40" enctype="multipart/form-data" action="{{ URL('dashboard/swara_nusvantara/prosestambah') }}" method="POST">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input readonly class="form-control getDateTime {{ General::validForm($errors->first('tanggal_publikasi_swara_nusvantaras')) }}" id="tanggal_publikasi_swara_nusvantaras" type="text" name="tanggal_publikasi_swara_nusvantaras" value="{{Request::old('tanggal_publikasi_swara_nusvantaras') == '' ? General::ubahDBKeTanggalwaktu(date('Y-m-d H:i:s')) : Request::old('tanggal_publikasi_swara_nusvantaras')}}">
