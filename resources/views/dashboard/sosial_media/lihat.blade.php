					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="right-align">
								{{ General::tambah($link_sosial_media,'dashboard/sosial_media/tambah') }}
							</div>
						</div>
					</div>
				</div>
				<div class="card-body">
	            	...
	            	<div class="scrolltable">
                        <table id="tablesort" class="table table-responsive-sm table-bordered table-striped table-sm">
				    		<thead>
				    			<tr>
				    				@if(General::totalHakAkses($link_sosial_media) != 0)
						    			<th width="5px"></th>
						    		@endif
								    			...
								    			<td class="nowrap">
											      	<div class="dropdown">
										            	...
										            	<div class="dropdown-menu" aria-labelledby="dropdownMenu2" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;">
										            		{{General::edit($link_sosial_media,'dashboard/sosial_media/edit/'.$sosial_medias->id_sosial_medias)}}
										            		<div class="dropdown-divider"></div>
										            		{{General::hapus($link_sosial_media,'dashboard/sosial_media/hapus/'.$sosial_medias->id_sosial_medias, $sosial_medias->id_sosial_medias.' - '.$sosial_medias->nama_sosial_medias)}}
										            	</div>
										            </div>
											    </td>
								    		@endif
