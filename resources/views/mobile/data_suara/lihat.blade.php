    ...
    <section class="contact-one">
        ...
        <div class="container">
            <div class="section-title text-center" style="margin-top:50px;">
                ...
                <span class="section-title__tagline">Data Suara</span>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="number" placeholder="Tahun" name="tahun_data_suaras" value="{{Request::old('tahun_data_suaras') == '' ? date('Y') : Request::old('tahun_data_suaras')}}">
                        ...
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="text" placeholder="Nama" name="nama_data_suaras" value="{{Request::old('nama_data_suaras')}}">
                                {{General::pesanErrorForm($errors->first('nama_data_suaras'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="text" placeholder="No TPS" name="tps_data_suaras" value="{{Request::old('tps_data_suaras')}}">
                                {{General::pesanErrorForm($errors->first('tps_data_suaras'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="number" placeholder="RT" name="rt_data_suaras" value="{{Request::old('rt_data_suaras')}}">
                                {{General::pesanErrorForm($errors->first('rt_data_suaras'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="number" placeholder="RW" name="rw_data_suaras" value="{{Request::old('rw_data_suaras')}}">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="contact-one__btn-box">
                                <button type="submit" class="thm-btn contact-one__btn">Kirim Data Suara</button>
                            </div>
                        </div>
                    </div>
                </form>
