				...
				<form class="form-horizontal m-t-40" enctype="multipart/form-data" action="{{ URL('dashboard/slideshow/prosestambah') }}" method="POST">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control {{ General::validForm($errors->first('text2_slideshows')) }}" id="text2_slideshows" name="text2_slideshows" rows="5">{{Request::old('text2_slideshows')}}</textarea>
