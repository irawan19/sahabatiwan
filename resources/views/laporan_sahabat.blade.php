    ...
    <section class="contact-one">
        ...
        <div class="container">
            <div class="section-title text-center">
                ...
                <span class="section-title__tagline">Laporan Sahabat</span>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
							    <label class="labelform" for="userfile_file_laporan_sahabat">File </label>
                                <br/>
                                <input id="userfile_file_laporan_sahabat" type="file" name="userfile_file_laporan_sahabat">
                                {{General::pesanErrorForm($errors->first('userfile_file_laporan_sahabat'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="text" placeholder="Nama" name="nama_laporan_sahabats" value="{{Request::old('nama_laporan_sahabats')}}">
                                {{General::pesanErrorForm($errors->first('nama_laporan_sahabats'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="number" placeholder="Telepon" name="telepon_laporan_sahabats" value="{{Request::old('telepon_laporan_sahabats')}}">
                                {{General::pesanErrorForm($errors->first('telepon_laporan_sahabats'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                                <input type="email" placeholder="Email" name="email_laporan_sahabats" value="{{Request::old('email_laporan_sahabats')}}">
                                {{General::pesanErrorForm($errors->first('email_laporan_sahabats'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="contact-one__input-box text-message-box">
                                <textarea name="alamat_laporan_sahabats" placeholder="Alamat">{{Request::old('alamat_laporan_sahabats')}}</textarea>
                                {{General::pesanErrorForm($errors->first('alamat_laporan_sahabats'))}}
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="contact-one__input-box text-message-box">
                                <textarea name="aduan_laporan_sahabats" placeholder="Aduan">{{Request::old('aduan_laporan_sahabats')}}</textarea>
                                {{General::pesanErrorForm($errors->first('aduan_laporan_sahabats'))}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="contact-one__btn-box">
                                <button type="submit" class="thm-btn contact-one__btn">Kirim Laporan</button>
                            </div>
                        </div>
                    </div>
                </form>
